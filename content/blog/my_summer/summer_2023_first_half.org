...
<figure>
    <center>
       <img src="/static/images/blog/switch_hacks_and_skulls.jpg" width="30%" />
...
* @@html:<img src="/static/images/blog/Switch_Logo.png", width="10%" />@@ Switch hacks
...
** @@html:<img src="/static/images/blog/reentry_racoon.png", width="10%" />@@Actual Switch hacks
...
* @@html:<img src="/static/images/blog/Qubes_OS_Logo.png", width="10%" />@@ Now daily driving Qubes on Thinkpad T430
...
#+BEGIN_EXPORT html
<small>This blog is (not) sponsored by <a href="https://kijiji.ca"><img src=/static/images/blog/Kijiji_Logo.png width="3%"/></a></small>
#+END_EXPORT
* @@html:<img src="/static/images/blog/openwrt_icon.png", width="10%" />@@ Openwrt
