...
I'm currently using a free Oracle VPS using an Ampere quad core CPU and 24GB of RAM. Currently using it to [[/posts/oracle_mc_server][host a private Minecraft server for free]]. I hope to do more with it in the future.
